...
import {
    DeleteSpecialtyActionAsync,
    GetSpecialtiesActionAsync,
} from '../../Redux/ReducerAPI/SpecialtyReducer';
...
const SpecialtyManagement = () => {
    ...
    const handleDelete = specialtyId => {
        run(DeleteSpecialtyActionAsync(specialtyId), () => {});
    };
    ...
    return (
        <>
            <div className="flex items-center justify-between mb-1">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 mb-1">Quản lý chuyên khoa</h1>
                    <p className="text-sm text-gray-500">Danh sách chuyên khoa y tế hiện có</p>
                </div>
                <Button
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-end">
                    <div className="flex-1">
                        <form onSubmit={handleSearchSubmit} className="relative">
                            ...
                            <Input
                                type="text"
                                placeholder="Nhấn Enter để tìm kiếm chuyên khoa..."
                                value={searchInput}
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-3">
                <div className="border-b border-gray-200 px-1 py-4">
                    <div className="flex items-center justify-between">
                        <CardTitle className="text-base">Danh sách chuyên khoa</CardTitle>
                        <Badge variant="secondary" className="text-xs">
                            {filteredData.length} chuyên khoa
                        </Badge>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-3">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="text-sm text-gray-600">
                        ...
                        tổng số {filteredData.length} chuyên khoa
                    </div>
            ...
            <AddSpecialtyModal open={isModalOpen} onOpenChange={setIsModalOpen} />
        </>
    );
};
