...
export const getGenderIcon = gender => {
    const icons = {
        Male: <Mars className="h-3 w-3 text-gray-500" />,
        Female: <Venus className="h-3 w-3 text-gray-500" />,
        Other: <HelpCircle className="h-3 w-3 text-gray-500" />,
    };
    return icons[gender] || <HelpCircle className="h-3 w-3 text-gray-500" />;
};
